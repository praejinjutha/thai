...
class PlanningInformation extends CI_Controller
{
    ...
    public function Retire()
    {
        ...
        $this->data['view_file'] = 'PersonnelHome/PlanningInformation/PlanningInformationRetire';
        $this->load->view(THEMES, $this->data);
    }
    public function Show()
    {
        $this->data['loopYear'] = loopYear();
        $this->data['view_file'] = 'PersonnelHome/PlanningInformation/PlanningInformationShow';
        $this->load->view(THEMES, $this->data);
    }
