...
class RequestForInsignia extends CI_Controller
{
    function __construct()
    {
        parent::__construct();
        $this->load->database();
        $this->load->model('User_model/RequestForInsignia_model');
    ...
    {
        $ResultData = $this->RequestForInsignia_model->get_NationalID_UserData()->result();
        foreach ($ResultData as $row) {
            $this->data["NationalID"] = $row->NationalID;
        }
        
        $FullName = $this->RequestForInsignia_model->get_Fullname()->result();
        ...
        $this->data['view_file'] = 'PersonnelHome_User/RequestForInsignia/RequestForInsigniaHome';
