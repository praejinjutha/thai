...
class HonorAward extends CI_Controller
{
    function __construct()
    {
        parent::__construct();
        $this->load->database();
        $this->load->model('User_model/HonorAward_model');
    ...
    public function index()
    {
        ...
        $this->data['view_file'] = 'PersonnelHome_User/HonorAward/HonorAwardHome';
    ...
    function Insert_HonorAward() {
        ...
        $results = $this->HonorAward_model->insert_PDO_HonorAward($Data, $FileNm, $Attachment, $Pic1, $Pic2, $Pic3, $Pic4, $Pic5, $Pic6);
        if ($results) { 
            $msg = 'Success';
        } else {
            $msg = 'error';
