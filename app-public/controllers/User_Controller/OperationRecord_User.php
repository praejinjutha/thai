...
class OperationRecord_User extends CI_Controller
{
    function __construct()
    {
        parent::__construct();
        $this->load->database();
        $this->load->model('User_model/OperationRecord_model');
    ...
    public function index()
    {
        ...
        $this->data['view_file'] = 'PersonnelHome_User/OperationRecord/OperationRecordHome';
    ...
    public function Sum()
    {
        ...
        $this->data['day'] = $this->ThDate(); 
        $this->data['view_file'] = 'PersonnelHome_User/OperationRecord/OperationRecordSum';
        $this->load->view(THEMES, $this->data);
    }
