...
class IDplan extends CI_Controller
{
    ...
    public function show($IDCard)
    {
        ...
        $this->data['loopYear'] = loopYear();
        $this->data['view_file'] = 'PersonnelHome/IDplan/IDplanShow';
        $this->load->view(THEMES, $this->data);
    }
    ...
    {   
        ...
        $results = $this->IDplan_model->fech_IDPlanYear($Year)->result();
    ...
    public function update_Status(){
        ...
        $results = $this->IDplan_model->update_Status($id, $Status);
