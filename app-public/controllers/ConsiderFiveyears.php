...
class ConsiderFiveyears extends CI_Controller
{
    function __construct()
    {
        parent::__construct();
        $this->load->database();
        $this->load->model('ConsiderFiveyears_model');
    ...
    public function index()
    {
        ...
        $FullName = $this->ConsiderFiveyears_model->get_FullName();
        $this->data["FullName"] = $FullName->result();

        $this->data['loopYear'] = loopYear();
        $this->data['view_file'] = 'PersonnelHome/ConsiderFiveyears/ConsiderFiveyearsHome';
    ...
    {   
        ...
        if($Position == NULL && $IDCard == NULL){
            $results = $this->ConsiderFiveyears_model->fech_ConsiderFiveyears()->result();
        }elseif($Position != NULL && $IDCard == NULL){
            $results = $this->ConsiderFiveyears_model->fech_ConsiderFiveyearsPos($Position)->result();
        }elseif($Position == NULL && $IDCard != NULL){
            $results = $this->ConsiderFiveyears_model->fech_ConsiderFiveyearsFullname($IDCard)->result();
        }elseif($Position != NULL && $IDCard != NULL){
            $results = $this->ConsiderFiveyears_model->fech_ConsiderFiveyearsAll($Position, $IDCard)->result();
        }
