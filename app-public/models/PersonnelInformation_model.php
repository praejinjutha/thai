...
class PersonnelInformation_model extends CI_Model
{
    ...
    {
       $query = $this->db->query("SELECT MData.*, MNData.*,EHData.*,PAll.*, Pos.*, TType.*, AStan.*, MData.UpdatedAt
        FROM SMPr_MenuStaData MData
    ...
    {
        $existingData = $this->db->get_where('SMPr_MenuStaData', array('IDCard' => $IDCard))->row_array();

        if (!empty($existingData)) {
            $this->db->where('IDCard', $IDCard)->update('SMPr_MenuStaData', $MenuStaData);
        } else {
            $MenuStaData['IDCard'] = $IDCard;
            $this->db->insert('SMPr_MenuStaData', $MenuStaData);
        }

        $existingData = $this->db->get_where('SMPr_MoneyData', array('IDCard' => $IDCard))->row_array();

        if (!empty($existingData)) {
            $this->db->where('IDCard', $IDCard)->update('SMPr_MoneyData', $MoneyData);
        } else {
            $MoneyData['IDCard'] = $IDCard;
            $this->db->insert('SMPr_MoneyData', $MoneyData);
        }

        $Enhance = $this->db->get_where('SMPr_EnhanceData', array('IDCard' => $IDCard))->num_rows();

        if ($Enhance == 0) {
            $EnhanceData['IDCard'] = $IDCard;
            $this->db->insert('SMPr_EnhanceData', $EnhanceData);
        } else {
            $this->db->where('IDCard', $IDCard)->update('SMPr_EnhanceData', $EnhanceData);
        }

        $existingData = $this->db->get_where('SMPr_PicAll', array('IDCard' => $IDCard))->row_array();

        if (!empty($existingData)) {
            $this->db->where('IDCard', $IDCard)->update('SMPr_PicAll', $PicAll);
        } else {
            $PicAll['IDCard'] = $IDCard;
            $this->db->insert('SMPr_PicAll', $PicAll);
        }
...
// *****************************************  Query Family Model  *****************************************  
    ...
    function get_PersonnelFamily($id)
    {
        return $this->db->query("SELECT * FROM SMPr_RelaFamily WHERE IDCard = '$id' ");
    }
...
// *****************************************  Query Study Model  *****************************************  
    ...
    function get_PersonnelStudy($id)
    {
        return $this->db->query("SELECT * FROM SMPr_EduData WHERE IDCard = '$id' ");
    }
    function get_PersonnelFame($id)
    {
        return $this->db->query("SELECT IDCard, FType, Agencies, RecieveYear, FileNm, P_at, CreatedAt, UpdatedAt  FROM SMPr_FameData WHERE IDCard = '$id' ");
    }
...
// *****************************************  Query Training Model  ***************************************** 
    function get_PersonnelTraining($id)
    {
        return $this->db->query("SELECT * FROM SMPr_HTrain WHERE IDCard = '$id' ");
    }
...
// *****************************************  Query Position Model  ***************************************** 
    function get_PersonnelPosition($id)
    {
        return $this->db->query("SELECT * FROM SMPr_HPreferment WHERE IDCard = '$id' ");
    }
...
// *****************************************  Query Teaching Model  ***************************************** 
    function get_PersonnelTeaching($id)
    {
        return $this->db->query("SELECT * FROM SMPr_TeachDataSubj WHERE IDCard = '$id' ");
    }
...
// *****************************************  Query License Model  ***************************************** 
    ...
    function get_PersonnelLicense($id)
    {
        return $this->db->query("SELECT * FROM SMPr_LProfession WHERE IDCard = '$id' ");
    }
...
// *****************************************  Query Leave Model  ***************************************** 
    function get_PersonnelLeave($id)
    {
        return $this->db->query("SELECT * FROM SMPr_HVacaYear WHERE IDCard = '$id' ");
    }
    ...
    function get_PersonnelRename($id)
    {
        return $this->db->query("SELECT * FROM SMPr_HChangeFL WHERE IDCard = '$id' ");
    }
...
// *****************************************  Query Insignia Model  ***************************************** 
    function get_PersonnelInsignia($id)
    {
        return $this->db->query("SELECT * FROM SMPr_HRRoyal WHERE IDCard = '$id' ");
    }
