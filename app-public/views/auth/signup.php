    ...
    <div class="container">
        <div class="row mt-5 fw-bold">
            <div class="col-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title text-center mt-3 fw-bold">ลงทะเบียนเข้าใช้งาน</h4>
                        <form action="<?= site_url('auth/register') ?>" method="POST" class="form-horizontal">
                            <div class="form-group mt-3">
                                <label for="exampleInputName1 font-black" style="color: #000;">
                                    <font color="red">*</font> ชื่อ - สกุล (ระบุคำนำหน้า)
                                </label>
                                <input type="text" class="form-control" id="name" name="name" placeholder="ชื่อ - สกุล (ระบุคำนำหน้า)" required>
                            </div>
                            <input type="text" class="form-control" id="StatusPersonal" name="StatusPersonal" value="user" hidden>
                            <div class="form-group mt-3">
                                <label for="exampleInputEmail3" style="color: #000;">
                                    <font color="red">*</font> เลขบัตรประชาชน
                                </label>
                                <input type="text" class="form-control" id="idcard" name="idcard" placeholder="เลขบัตรประชาชน" maxlength="13" required>
                            ...
                            <div class="form-group mt-3">
                                ...
                                <input type="text" class="form-control" id="phone" name="phone" placeholder="หมายเลขโทรศัพท์" required>
                            </div>
                            <div class="form-group mt-3">
                                <label for="exampleInputPassword4" style="color: #000;">
                                    <font color="red">*</font> ชื่อผู้ใช้ (Username) ประกอบด้วยอักษร A-Z, a-z, 0-9 เท่านั้น
                                </label>
                                <input type="text" class="form-control" id="username" name="username" placeholder="ชื่อผู้ใช้ (Username) ประกอบด้วยอักษร A-Z, a-z, 0-9 เท่านั้น" required>
                            </div>
                            <div class="form-group mt-3">
                                <label for="exampleInputPassword4" style="color: #000;">
                                    <font color="red">*</font> รหัสผ่าน (Password) ประกอบด้วยอักษร A-Z, a-z, 0-9, !, @, #, $ เท่านั้น
                                </label>
                                <input type="text" class="form-control" id="password" name="password" placeholder="รหัสผ่าน (Password) ประกอบด้วยอักษร A-Z, a-z, 0-9, !, @, #, $ เท่านั้น" required>
                            </div>
                            <div class="form-group mt-3">
                                <label for="exampleInputCity1" style="color: #000;">
                                    <font color="red">*</font> ยืนยันรหัสผ่าน
                                </label>
                                <input type="text" class="form-control" id="confirmPassword" name="confirmPassword" placeholder="ยืนยันรหัสผ่าน" required>
                            </div>
                            <div class="form-group mt-3">
                                <label for="exampleFormControlTextarea1" style="color: #000;">ข้อตกลงการใช้งานและนโยบายข้อมูลส่วนบุคคล</label>
                                <textarea class="form-control" rows="10">ข้อกำหนดและเงื่อนไขในการใช้งานที่แสดงไว้ ณ ที่นี้ (ต่อไปนี้เรียกว่า "ข้อกำหนดและเงื่อนไขฯ") ระบุถึงข้อกำหนดระหว่าง บริษัท โมด โซลูชั่น จำกัด (ต่อไปนี้เรียกว่า "บริษัทฯ") และผู้ใช้ (ต่อไปนี้เรียกว่า "ผู้ใช้") เกี่ยวกับบริการหรือคุณลักษณะใดๆ ของ SmartS Paperless (ต่อไปนี้เรียกว่า "บริการฯ") ซึ่งบริษัทฯ เป็นผู้ให้บริการ
...
จบข้อความ
                            ...
                            <div class="col text-center">
                                <button type="submit" class="button-blue-s mt-3">ลงทะเบียน</button>
                                <a href="<?= site_url('auth') ?>" class="button-red-s">กลับสู่หน้าหลัก</a>
                            </div>
                        </form>
                    </div>
                </div>
    ...
    <script>
        ...
        <?php if ($this->session->flashdata('msg_password')) : ?>
            swal.fire({
                icon: 'error',
                title: "<?= $this->session->flashdata('msg_password') ?>",
                type: "error"
            })
        <?php endif; ?>
        ...
        <?php if ($this->session->flashdata('msg_error')) : ?>
            swal.fire({
                icon: 'error',
                title: "<?= $this->session->flashdata('msg_error') ?>",
                type: "error"
            })
        <?php endif; ?>
    </script>
    ...
    <script src="<?= $themes ?>assets/vendors/base/vendor.bundle.base.js"></script>
</body>
