...
<head>
    ...
    #wordByWordTable {
        table-layout: fixed;
        /* ใช้การจัดการขนาดความกว้างของคอลัมน์แบบคงที่ */
        width: 100%;
        /* กำหนดให้ตารางเต็มขนาดของพื้นที่ที่สามารถใช้ได้ */
        margin: 0 auto;
        /* จัดให้ตารางอยู่ตรงกลาง */
    ...
    #wordByWordTable td:nth-child(1) {
        width: 20%;
        /* ปรับความกว้างของคอลัมน์แรก */
    }

    #wordByWordTable td:nth-child(2) {
        width: 80%;
        /* ปรับความกว้างของคอลัมน์ที่สอง */
    }
    ...
    input[type="radio"]:checked {
        ...
        background-size: auto 0.5%;
        /* ขนาดของวงกลมสีเขียวด้านในเมื่อถูกเลือก */
    }
    ...
    input[type="radio"]:not(:checked) {
        ...
        background-size: 80%;
        /* ขนาดของวงกลมสีเทาด้านนอกเมื่อไม่ถูกเลือก */
    }
    </style>
</head>
...
<body class="page-portfolio">
    ...
    <main id="main">
        ...
        <img src="../assets/img/navbar.png" alt="Navbar"
            style="width: 100%; height: auto; display: flex; justify-content: center; align-items: center; pointer-events: none;">
    </main>
    ...
    <main>
        ...
        <div style="display: flex; justify-content: center; align-items: center;">
            <div
                style="width: 30%; height: 100px; display: flex; align-items: center; justify-content: center; position: relative;">
                <textarea id="searchInput" placeholder="กรอกข้อมูลที่นี่.."
                    style="width: 100%; height: 90%; padding-right: 30px; resize: none; border-radius: 10px; text-indent: 1rem; font-size: 18px; margin-bottom: 30px;"></textarea>
