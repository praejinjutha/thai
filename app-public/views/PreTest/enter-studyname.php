...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col-4">
            ...
            <form method="post" action="<?= site_url('PreTest_controller/study') ?>" enctype="multipart/form-data">
                <div class="row">
...
function get_Stat() {
    ...
    $.ajax({
        url: "<?= site_url('PreTest_controller/get_Stat') ?>",
        method: "POST",
        dataType: 'json',
...
document.getElementById('confirm').addEventListener('click', function(event) {
    ...
    if (studentNo === '') {
        ...
        if (!found) {
            ...
            var url = "<?= site_url('PreTest_controller/PreTest?No=') ?>" + studentNo;
