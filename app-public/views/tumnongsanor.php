...
<?php
$tumnongsanor = $_GET['tumnongsanor'] ?? ''; // ดึงค่าของพารามิเตอร์ tumnongsanor จาก URL
$tumnongsanor_title = '';
// กำหนดข้อความของแต่ละบทเรียน
if (empty($tumnongsanor) || $tumnongsanor == 1) {
  $tumnongsanor = 1;
  $image_file = "../assets/img/literature/kapyani/tumnongsanor1.jpg";
  $tumnongsanor_title = "เย็นเย็น";
} elseif ($tumnongsanor == 2) {
    $image_file = "../assets/img/literature/kapyani/tumnongsanor2.jpg";
    $tumnongsanor_title = "เกี่ยวกับทรงผม";
} elseif ($tumnongsanor == 3) {
    $image_file = "../assets/img/literature/kapyani/tumnongsanor3.jpg";
    $tumnongsanor_title = "คิดถึง เพื่อนรัก";
}
...
<div class="container py-5">
    <div class="row">
        <div class="col-md-9 order-md-4">
            ...
            <?php if (!empty($tumnongsanor)) : ?>
                <div class="d-flex flex-column text-left mb-3" style="margin-left: 30px;">

                    <div class="mb-5">
                        <img id="tumnongsanorImage" width="100%" height="auto" src="<?= $image_file ?>" alt="tumnongsanor Image" style="margin-top: 80px;">
                        <?php
                        $audio_file = '';
                        if ($tumnongsanor == 1) {
                            $audio_file = "../assets/audio/second3lines/tumnongsanor1.wav";
                        } elseif ($tumnongsanor == 2) {
                            $audio_file = "../assets/audio/second3lines/tumnongsanor2.wav";
                        } elseif ($tumnongsanor == 3) {
                            $audio_file = "../assets/audio/second3lines/tumnongsanor3.wav";
                        } 
                        ?>
        ...
        <div class="col-md-3 order-md-1">
            ...
            <h4 style="font-size: 36px; font-weight: bold;">ทำนองเสนาะ</h4>

    </div>
            <br>
                <ul class="list-group">
                    <?php for ($i = 1; $i <= 3; $i++) : ?>
                        <li class="list-group-item <?php echo ($tumnongsanor == $i) ? 'active' : ''; ?>" style="background-color: <?php echo ($tumnongsanor == $i) ? '#A4DBD0' : '#f8f9fa'; ?>;">
                            <a href="?tumnongsanor=<?php echo $i; ?>" class="text-decoration-none">
                                <?php 
                                $tumnongsanor_text = '';
                                if ($i == 1) {
                                    $tumnongsanor_text = "๑. เย็นเย็น";
                                } elseif ($i == 2) {
                                    $tumnongsanor_text = "๒. เกี่ยวกับทรงผม";
                                } elseif ($i == 3) {
