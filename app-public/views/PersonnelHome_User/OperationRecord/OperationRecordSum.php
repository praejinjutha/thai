        ...
        <div class="card-body">
            <div class="row  m-2 mt-4">
                <div class="col-md-2">
                    ...
                    <form method="POST" action="<?= site_url('User_Controller/OperationRecord_User/Export_Month') ?>">
                        ...
                        <div class="row mt-3">
                            ...
                            <hr>
                            <a href="<?= site_url('User_Controller/OperationRecord_User') ?>" class="btn btn-success fw-bold fs-4"> เช็คประจำวัน
                            </a>
                        </div>
                        <div class="row mt-2">
...
function getPersonnel() {
    ...
    $.ajax({
        url: "<?= site_url('User_Controller/OperationRecord_User/get_SumPersonnelData') ?>",
        method: "POST",
        dataType: 'json',
...
function get_MonthOperation() {
    ...
    $.ajax({
        url: "<?= site_url('User_Controller/OperationRecord_User/get_MonthOperationData') ?>",
        method: "POST",
        data:{
            Month: Month,
...
function get_TermOperation() {
    ...
    console.log(Term);
    $.ajax({
        url: "<?= site_url('User_Controller/OperationRecord_User/get_TermOperationData') ?>",
        method: "POST",
        data:{
            Term: Term,
            personnelArray: JSON.stringify(personnelArray)
...
function get_SumMonthPersonnel() {
    ...
    $.ajax({
        url: "<?= site_url('User_Controller/OperationRecord_User/Official_SumMonth') ?>",
        method: "POST",
        data: {
            Month: Month
        },
...
function get_SumTermPersonnel() {
    ...
    $.ajax({
        url: "<?= site_url('User_Controller/OperationRecord_User/Official_SumTerm') ?>",
        method: "POST",
        data: {
            Term: Term
        },
