                                                    ...
                                                    <div class="form-group row fw-bold">
                                                        ...
                                                        <div class="col-md-6">
                                                            <input type="text" class="form-control" id="IDCard"
                                                                name="IDCard" value="<?= $this->data['IDCard'] ?>" readonly>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6 mt-3">
                                                ...
                                                <div class="col-md-6 mt-3 mb-3">
                                                    <div class="form-group row fw-bold">
                                                        <label class="col-md-5 col-form-label">สถานภาพการทำงาน
                                                            <span style="color: red;">*</span></label>
                                                        <div class="col-md-6">
                                                            <select class="form-select" name="NStatus" id="NStatus" required>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group row fw-bold">
                                                ...
                                                <input type="date" class="form-control" id="BirthDate" name="BirthDate"
                                                    value="<?= empty($this->data['BirthDate']) ? date("Y-m-d") : $this->data['BirthDate'] ?>"
                                                        ...
                                                        <div class="form-group row fw-bold">
                                                            ...
                                                            <div class="col-md-6">
                                                                <input type="date" class="form-control" id="PlaceDate"
                                                                    name="PlaceDate"
                                                                    value="<?= empty($this->data['PlaceDate']) ? date("Y-m-d") : $this->data['PlaceDate'] ?>">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group row fw-bold">
                                                            ...
                                                            <div class="col-md-6">
                                                                <input type="date" class="form-control" id="StartDate"
                                                                    name="StartDate"
                                                                    value="<?= empty($this->data['StartDate']) ? date("Y-m-d") : $this->data['StartDate'] ?>">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                        ...
                                                        <div class="form-group row fw-bold">
                                                            ...
                                                            <div class="col-md-6">
                                                                <input type="date" class="form-control"
                                                                    ...
                                                                    value="<?= empty($this->data['LProfessionFirstDate']) ? date("Y-m-d") : $this->data['LProfessionFirstDate'] ?>">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group row fw-bold">
                                                            ...
                                                            <div class="col-md-6">
                                                                <input type="date" class="form-control" id="NowDate"
                                                                    name="NowDate"
                                                                    value="<?= empty($this->data['NowDate']) ? date("Y-m-d") : $this->data['NowDate'] ?>">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group row fw-bold">
                                                            ...
                                                            if ($this->data['MemberKBK'] == "Y") {
                                                                $newSalary = $this->data['MSalary'] * 1.03; 
                                                                echo '<input type="text" class="form-control text-end" id="CAccessKBK" name="CAccessKBK" value="' . number_format($newSalary, 2) . '" readonly>';
                                                            } else {
                                                                echo '<input type="text" class="form-control text-end" id="CAccessKBK" name="CAccessKBK" value="0.00" readonly>';
                                                            }
                                                            ?>
                                                            </div>&nbsp;
                                            ...
                                            <div class="form-group row fw-bold mb-1">
                                                ...
                                                <div class="col-md-5">
                                                    <input type="date" class="form-control" id="PoDate" name="PoDate"
                                                        value="<?= empty($this->data['PoDate']) ? date("Y-m-d") : $this->data['PoDate'] ?>">
                                                </div>
                                            </div>
                                            <div class="form-group row fw-bold mb-1">
                                            ...
                                            <div class="form-group row fw-bold mb-1">
                                                ...
                                                <div class="col-md-5">
                                                    <input type="text" class="form-control text-end" id="MSalary"
                                                        name="MSalary"
                                                        value="<?= !empty($this->data['MSalary']) ? number_format($this->data['MSalary'], 2) : '0.00' ?>">
                                                </div>
                                            ...
                                            <div class="form-group row fw-bold mb-1">
                                                ...
                                                <div class="col-md-5">
                                                    <input type="text" class="form-control text-end" id="EMoney"
                                                        name="EMoney"
                                                        value="<?= !empty($this->data['EMoney']) ? number_format($this->data['EMoney'], 2) : '0.00' ?>">
                                            ...
                                            <div class="form-group row fw-bold mb-1">
                                                ...
                                                <div class="col-md-5">
                                                    <input type="text" class="form-control text-end" id="PoSalary"
                                                        name="PoSalary"
                                                        value="<?= !empty($this->data['PoSalary']) ? number_format($this->data['PoSalary'], 2) : '0.00' ?>">
                                            ...
                                            <div class="form-group row fw-bold">
                                                ...
                                                <div class="col-md-5 ">
                                                    <input type="text" class="form-control text-end" name="Salsum"
                                                        id="Salsum"
                                                        value="<?= !empty($this->data['Salsum']) ? number_format($this->data['Salsum'], 2) : '0.00' ?>" readonly>
                                                </div>
                                                <label class="col-md-2 col-form-label">บาท</label>
                                            </div>
                                        </div>
                                            ...
                                            <div class="form-group row fw-bold">
                                                ...
                                                <div class="col-md-7">
                                                    <input type="date" class="form-control" id="RecieveDate"
                                                        name="RecieveDate" value="<?= empty($this->data['RecieveDate']) ? date("Y-m-d") : $this->data['RecieveDate'] ?>">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group row fw-bold">
                                                ...
                                                <div class="col-md-7">
                                                    <input type="date" class="form-control" id="ResultDate"
                                                        name="ResultDate" value="<?= empty($this->data['ResultDate']) ? date("Y-m-d") : $this->data['ResultDate'] ?>">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
...
$('#UpdateData').submit(function(event) {
    ...
    $.ajax({
        url: "<?= site_url('User_Controller/PersonnelInformation/update_PersonnelData') ?>",
        type: "POST",
        data: formData,
        processData: false,
        contentType: false,
...
function MemberKBKChange() {
    ...
    if (selectedValue === "Y") {
        var newSalary = <?= $this->data['MSalary'] ?> * 1.03;
...
function getPersonnelFamily() {
    ...
    $.ajax({
        url: "<?= site_url('User_Controller/PersonnelInformation/get_PersonnelFamily') ?>",
        method: "POST",
        dataType: 'json',
        success: function(data) { 
            table_body.html('');
...
function getPersonnelStudy() {
    ...
    $.ajax({
        url: "<?= site_url('User_Controller/PersonnelInformation/get_PersonnelStudy') ?>",
        method: "POST",
        dataType: 'json',
        success: function(data) {
            table_body.html('');
...
function getPersonnelFame() {
    ...
    $.ajax({
        url: "<?= site_url('User_Controller/PersonnelInformation/get_PersonnelFame') ?>",
        method: "POST", 
        dataType: 'json',
        success: function(data) {
            table_body.html('');
...
function getPersonnelTraining() {
    ...
    $.ajax({
        url: "<?= site_url('User_Controller/PersonnelInformation/get_PersonnelTraining') ?>",
        method: "POST",
        dataType: 'json',
        success: function(data) {
            table_body.html('');
...
function getPersonnelPosition() {
    ...
    $.ajax({
        url: "<?= site_url('User_Controller/PersonnelInformation/get_PersonnelPosition') ?>",
        method: "POST",
        dataType: 'json',
        success: function(data) {
            table_body.html('');
...
function getPersonnelTeaching() {
    ...
    $.ajax({
        url: "<?= site_url('User_Controller/PersonnelInformation/get_PersonnelTeaching') ?>",
        method: "POST",
        dataType: 'json',
        success: function(data) {
            table_body.html('');
...
function getPersonnelLicense() {
    ...
    $.ajax({
        url: "<?= site_url('User_Controller/PersonnelInformation/get_PersonnelLicense') ?>",
        method: "POST",
        dataType: 'json',
        success: function(data) {
            table_body.html('');
...
function getPersonnelLeave() {
    ...
    $.ajax({
        url: "<?= site_url('User_Controller/PersonnelInformation/get_PersonnelLeave') ?>",
        method: "POST",
        dataType: 'json',
        success: function(data) {
            table_body.html('');
...
function getPersonnelRename() {
    ...
    $.ajax({
        url: "<?= site_url('User_Controller/PersonnelInformation/get_PersonnelRename') ?>",
        method: "POST",
        dataType: 'json',
        success: function(data) {
            table_body.html('');
...
function getPersonnelInsignia() {
    ...
    $.ajax({
        url: "<?= site_url('User_Controller/PersonnelInformation/get_PersonnelInsignia') ?>",
        method: "POST",
        dataType: 'json',
        success: function(data) {
            table_body.html('');
