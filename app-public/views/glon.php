...
<?php
$glon = $_GET['glon'] ?? ''; // ดึงค่าของพารามิเตอร์ glon จาก URL
$glon_title = '';
// กำหนดข้อความของแต่ละบทเรียน
if (empty($glon) || $glon == 1) {
  $glon = 1;
  $image_file = "../assets/img/literature/kapyani/glon1.jpg";
  $glon_title = "แด่คุณครูผู้น่ารัก";
} elseif ($glon == 2) {
    $image_file = "../assets/img/literature/kapyani/glon2.jpg";
    $glon_title = "รักเมืองไทย";
} elseif ($glon == 3) {
    $image_file = "../assets/img/literature/kapyani/glon3.jpg";
    $glon_title = "ก ข ก กา";
}
...
<div class="container py-5">
    <div class="row">
        <div class="col-md-9 order-md-4">
            ...
            <?php if (!empty($glon)) : ?>
                <div class="d-flex flex-column text-left mb-3" style="margin-left: 30px;">
                    ...
                    <div class="mb-5">
                        <img id="glonImage" width="100%" height="auto" src="<?= $image_file ?>" alt="glon Image" style="margin-top: 80px;">
                        <?php
                        $audio_file = '';
                        if ($glon == 1) {
                            $audio_file = "../assets/audio/first2lines/glon1.wav";
                        } elseif ($glon == 2) {
                            $audio_file = "../assets/audio/first2lines/glon2.wav";
                        } elseif ($glon == 3) {
                            $audio_file = "../assets/audio/first2lines/glon3.wav";
                        } 
                        ?>
        ...
        <div class="col-md-3 order-md-1">
            ...
            <h4 style="font-size: 40px; font-weight: bold;">กลอน</h4>

    </div>
            <br>
                <ul class="list-group">
                    <?php for ($i = 1; $i <= 3; $i++) : ?>
                        <li class="list-group-item <?php echo ($glon == $i) ? 'active' : ''; ?>" style="background-color: <?php echo ($glon == $i) ? '#A4DBD0' : '#f8f9fa'; ?>;">
                            <a href="?glon=<?php echo $i; ?>" class="text-decoration-none">
                                <?php 
                                $glon_text = '';
                                if ($i == 1) {
                                    $glon_text = "๑. แด่คุณครูผู้น่ารัก";
                                } elseif ($i == 2) {
                                    $glon_text = "๒. รักเมืองไทย";
                                } elseif ($i == 3) {
