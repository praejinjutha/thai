...
<head>
    ...
    body {
        ...
        /* ให้ภาพพื้นหลังขยายเต็มขนาดของพื้นที่ */
        background-repeat: no-repeat;
        margin-bottom: 40vh;
        /* สร้างพื้นที่เพิ่มด้านล่างของหน้าเว็บเท่ากับความสูงของหน้าเว็บ */
    }

    .recent-posts {
        display: flex;
        justify-content: center;
        /* จัดให้เป็นกึ่งกลางในแนวนอน */
        align-items: center;
        /* จัดให้เป็นกึ่งกลางในแนวตั้ง */
    }
    ...
    .post-box:hover {
        background-color: #8c6239;
        color: white;
        /* กำหนดสีข้อความเป็นสีขาวเมื่อโฮเวอร์ */
        padding: 2px 10px;
        /* ลดขนาด padding เพื่อลดขอบ */
        border-radius: 50px;
        /* เพิ่มขอบมนเรียว */
        display: flex;
        /* จัดให้ข้อความแสดงเป็น flex */
        align-items: center;
        /* จัดให้ข้อความอยู่กึ่งกลางในแนวตั้ง */
        justify-content: center;
        /* จัดให้ข้อความอยู่กึ่งกลางในแนวนอน */
        transition: all 0.3s ease;
        /* เพิ่ม transition เพื่อทำให้การเปลี่ยนแปลงเกิดอย่างนุ่มนวล */
    }
  ...
  border: none; border-radius: 5px; cursor: pointer; margin-right: 60px; margin-bottom: 20px;">ย้อนกลับ</button>
        ...
        <div class="container" data-aos="fade-up">
            ...
            <div class="row gy-5">
                <div class="col-xl-3 col-md-6" data-aos="fade-up" data-aos-delay="100">
                    <div class="post-box">
                        <h4 class="title"><a href="prose" class="stretched-link"
                                style="font-size: 28px; color: #8c6239;"> ✤ บทร้อยแก้ว</a></h4>
                ...
                <div class="col-xl-3 col-md-6" data-aos="fade-up" data-aos-delay="100">
                    <div class="post-box">
                        <h4 class="title"><a href="3" class="stretched-link" style="font-size: 28px; color: #8c6239;"> ✤
                                กาพย์ยานี</a></h4>
                ...
                <div class="col-xl-3 col-md-6" data-aos="fade-up" data-aos-delay="100">
                    <div class="post-box">
                        <h4 class="title"><a href="#" class="stretched-link" style="font-size: 28px; color: #8c6239; ">
                                ✤ โคลง</a></h4>
                ...
                <div class="col-xl-3 col-md-6" data-aos="fade-up" data-aos-delay="100">
                    <div class="post-box">
                        <h4 class="title"><a href="poetry" class="stretched-link"
                                style="font-size: 28px; color: #8c6239;"> ✤ บทร้อยกรอง</a></h4>
    ...
    $(document).ready(function() {
        ...
        $('.post-box .title a').click(function(e) {
            ...
            $(this).closest('.post-box').addClass(
            'active'); // เพิ่มคลาส "active" ให้กับ .post-box ที่มีลิงก์ที่คลิก
        });
        ...
        $('.post-box').hover(function() {
            ...
            if (!$(this).find('.title a').text().includes("บทร้อยแก้ว")) {
                $('.post-box.active').removeClass(
                'active'); // ลบคลาส "active" ในกรณีที่โฮเวอร์ไม่ได้เป็นบทร้อยแก้ว
            }
        });
    });
    </script>
