...
#practice-heading {
    position: relative;
    bottom: -50px; /* ปรับตามความเหมาะสม */
}

.service-item:nth-child(odd) {
    margin-bottom: 25px; /* ระยะห่างสำหรับแถวที่เป็นลำดับคู่ */
}

.service-item:nth-child(even) {
    margin-bottom: 70px; /* ระยะห่างสำหรับแถวที่เป็นลำดับคี่ */
}
...
.service-item {
    ...
    width:  auto;
    overflow: hidden; /* ป้องกันข้อความที่ยาวเกินขอบของคอลัมน์ */
    width: calc(33.33% ); /* กำหนดให้คอลัมน์มีความกว้าง 33.33% ของพื้นที่ทั้งหมดและลบระยะห่างระหว่างคอลัมน์ออก */
  margin-bottom: 20px; /* ระยะห่างระหว่างแต่ละคอลัมน์ */
  box-sizing: border-box; /* ให้ขอบของคอลัมน์นับเข้าไปในความกว้าง */
}


.services-list .row {
  display: flex;
  flex-wrap: wrap; /* ให้คอลัมน์ขึ้นบรรทัดใหม่เมื่อไม่พอที่จะแสดงทั้งหมด */
  
}

.services-list .service-item {
    display: flex;
    justify-content: flex-start; /* จัดให้ข้อความอยู่ชิดซ้าย */
...
.services-list .service-item h4 {
    ...
    width: 100%; /* กำหนดขนาดของข้อความให้เต็มคอลัมน์ */
    margin-left: 100px;
}
...
img {
    max-width: auto; /* รูปภาพจะไม่เกินขนาดความกว้างของพื้นที่ที่มันอยู่ */
    height: auto; /* ความสูงของรูปภาพจะปรับให้เหมาะสมกับขนาดความกว้าง */
}


.img-container, .img-con {
    display: flex;
    justify-content: center; /* จัดให้รูปอยู่ตรงกลาง */
}

.img-container img {
  margin-left: 100px;
  margin-right: 120px;
    margin-bottom: 50px; /* ลดระยะห่างด้านล่างของรูปภาพ */
}

.img-con {
  margin-left: 100px;
    margin-top: -40px; /* ปรับตามความต้องการของคุณ */
    margin-right: 120px;
    }


    .service-item a {
  color: #8c6239; /* เลือกสีที่คุณต้องการ */
}
...
<div class="container" style="margin-top: -100px;">
        <h2 id="practice-heading">ใบงานมาตราตัวสะกด<hr></h2>
    </div>
...
<div class="container">
        <h2 id="practice-heading">ใบงานทั่วไป<hr></h2>
        </div>
...
serviceItems.forEach(item => {
  if (item.textContent.includes('มาตราตัวสะกดแม่กก') || item.textContent.includes('หาดอกไม้ในเพลง')) {
