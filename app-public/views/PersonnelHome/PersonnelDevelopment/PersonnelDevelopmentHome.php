...
<div class="container-fild ">
                ...
                <div class="col-sm-12">
                    <div class="card m-3 mt-0">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12">
                                <form method="post" action="<?= site_url('PersonnelDevelopment/export') ?>">
                                    <div class="row">
    ...
    function get_PersonnelDevelopment() {
        ...
        $.ajax({
            url: "<?= site_url('PersonnelDevelopment/fech_PersonnelDevelopment') ?>",
            method: "POST",
            data: {
                Year: Year,
                IDCard: IDCard
    ...
    function get_PersonnelDevelopmentHou() {
        ...
        $.ajax({
            url: "<?= site_url('PersonnelDevelopment/fech_PersonnelDevelopmentHou') ?>",
            method: "POST",
            data: {
                Year: Year
            },
