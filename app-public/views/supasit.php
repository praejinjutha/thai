...
<?php
$supasit = $_GET['supasit'] ?? ''; // ดึงค่าของพารามิเตอร์ supasit จาก URL
$supasit_title = '';
// กำหนดข้อความของแต่ละบทเรียน
if (empty($supasit) || $supasit == 1) {
  $supasit = 1;
  $image_file = "../assets/img/literature/kapyani/supasit1.jpg";
  $supasit_title = "สุภาษิต";
}
?>
...
<div class="container py-5">
    <div class="row">
        <div class="col-md-9 order-md-4">
            ...
            <?php if (!empty($supasit)) : ?>
                <div class="d-flex flex-column text-left mb-3" style="margin-left: 30px;">

                    <div class="mb-5">
                        <img id="supasitImage" width="100%" height="auto" src="<?= $image_file ?>" alt="supasit Image" style="margin-top: 80px;">
                        <?php
                        $audio_file = '';
                        if ($supasit == 1) {
                            $audio_file = "../assets/audio/second3lines/supasit1.wav";
                        } 
                        ?>
        ...
        <div class="col-md-3 order-md-1">
            ...
            <h4 style="font-size: 40px; font-weight: bold;">สุภาษิต</h4>

    </div>
            <br>
                <ul class="list-group">
                    <?php for ($i = 1; $i <= 1; $i++) : ?>
                        <li class="list-group-item <?php echo ($supasit == $i) ? 'active' : ''; ?>" style="background-color: <?php echo ($supasit == $i) ? '#A4DBD0' : '#f8f9fa'; ?>;">
                            <a href="?supasit=<?php echo $i; ?>" class="text-decoration-none">
                                <?php 
                                $supasit_text = '';
                                if ($i == 1) {
