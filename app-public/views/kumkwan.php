...
<?php
$kumkwan = $_GET['kumkwan'] ?? ''; // ดึงค่าของพารามิเตอร์ kumkwan จาก URL
$kumkwan_title = '';
// กำหนดข้อความของแต่ละบทเรียน
if (empty($kumkwan) || $kumkwan == 1) {
  $kumkwan = 1;
  $image_file = "../assets/img/literature/kapyani/kumkwan1.jpg";
  $kumkwan_title = "คำขวัญ";
}
?>
...
<div class="container py-5">
    <div class="row">
        <div class="col-md-9 order-md-4">
            ...
            <?php if (!empty($kumkwan)) : ?>
                <div class="d-flex flex-column text-left mb-3" style="margin-left: 30px;">

                    <div class="mb-5">
                        <img id="kumkwanImage" width="100%" height="auto" src="<?= $image_file ?>" alt="kumkwan Image" style="margin-top: 80px;">
                        <?php
                        $audio_file = '';
                        if ($kumkwan == 1) {
                            $audio_file = "../assets/audio/second3lines/kumkwan1.wav";
                        } 
                        ?>
        ...
        <div class="col-md-3 order-md-1">
            ...
            <h4 style="font-size: 40px; font-weight: bold;">คำขวัญ</h4>

    </div>
            <br>
                <ul class="list-group">
                    <?php for ($i = 1; $i <= 1; $i++) : ?>
                        <li class="list-group-item <?php echo ($kumkwan == $i) ? 'active' : ''; ?>" style="background-color: <?php echo ($kumkwan == $i) ? '#A4DBD0' : '#f8f9fa'; ?>;">
                            <a href="?kumkwan=<?php echo $i; ?>" class="text-decoration-none">
                                <?php 
                                $kumkwan_text = '';
                                if ($i == 1) {
