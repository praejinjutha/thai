...
<?php
$botrsian = $_GET['botrsian'] ?? ''; // ดึงค่าของพารามิเตอร์ botrsian จาก URL
$botrsian_title = '';
// กำหนดข้อความของแต่ละบทเรียน
if (empty($botrsian) || $botrsian == 1) {
  $botrsian = 1;
  $image_file = "../assets/img/literature/kapyani/botrsian1.jpg";
  $botrsian_title = "บทอาเศียรวาท";
}
?>
...
<div class="container py-5">
    <div class="row">
        <div class="col-md-9 order-md-4">
            ...
            <?php if (!empty($botrsian)) : ?>
                <div class="d-flex flex-column text-left mb-3" style="margin-left: 30px;">

                    <div class="mb-5">
                        <img id="botrsianImage" width="100%" height="auto" src="<?= $image_file ?>" alt="botrsian Image" style="margin-top: 80px;">
                        <?php
                        $audio_file = '';
                        if ($botrsian == 1) {
                            $audio_file = "../assets/audio/second3lines/botrsian1.wav";
                        } 
                        ?>
        ...
        <div class="col-md-3 order-md-1">
            ...
            <h4 style="font-size: 40px; font-weight: bold;">บทอาเศียรวาท</h4>

    </div>
            <br>
                <ul class="list-group">
                    <?php for ($i = 1; $i <= 1; $i++) : ?>
                        <li class="list-group-item <?php echo ($botrsian == $i) ? 'active' : ''; ?>" style="background-color: <?php echo ($botrsian == $i) ? '#A4DBD0' : '#f8f9fa'; ?>;">
                            <a href="?botrsian=<?php echo $i; ?>" class="text-decoration-none">
                                <?php 
                                $botrsian_text = '';
                                if ($i == 1) {
