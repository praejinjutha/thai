...
<?php
$kumpungpoei = $_GET['kumpungpoei'] ?? ''; // ดึงค่าของพารามิเตอร์ kumpungpoei จาก URL
$kumpungpoei_title = '';
// กำหนดข้อความของแต่ละบทเรียน
if (empty($kumpungpoei) || $kumpungpoei == 1) {
  $kumpungpoei = 1;
  $image_file = "../assets/img/literature/kapyani/kumpungpoei1.jpg";
  $kumpungpoei_title = "คำพังเพย";
}
?>
...
<div class="container py-5">
    <div class="row">
        <div class="col-md-9 order-md-4">
            ...
            <?php if (!empty($kumpungpoei)) : ?>
                <div class="d-flex flex-column text-left mb-3" style="margin-left: 30px;">

                    <div class="mb-5">
                        <img id="kumpungpoeiImage" width="100%" height="auto" src="<?= $image_file ?>" alt="kumpungpoei Image" style="margin-top: 80px;">
                        <?php
                        $audio_file = '';
                        if ($kumpungpoei == 1) {
                            $audio_file = "../assets/audio/second3lines/kumpungpoei1.wav";
                        } 
                        ?>
        ...
        <div class="col-md-3 order-md-1">
            ...
            <h4 style="font-size: 40px; font-weight: bold;">คำพังเพย</h4>

    </div>
            <br>
                <ul class="list-group">
                    <?php for ($i = 1; $i <= 1; $i++) : ?>
                        <li class="list-group-item <?php echo ($kumpungpoei == $i) ? 'active' : ''; ?>" style="background-color: <?php echo ($kumpungpoei == $i) ? '#A4DBD0' : '#f8f9fa'; ?>;">
                            <a href="?kumpungpoei=<?php echo $i; ?>" class="text-decoration-none">
                                <?php 
                                $kumpungpoei_text = '';
                                if ($i == 1) {
