...
<?php
$botarkayan = $_GET['botarkayan'] ?? ''; // ดึงค่าของพารามิเตอร์ botarkayan จาก URL
$botarkayan_title = '';
// กำหนดข้อความของแต่ละบทเรียน
if (empty($botarkayan) || $botarkayan == 1) {
  $botarkayan = 1;
  $image_file = "../assets/img/literature/kapyani/botarkayan1.jpg";
  $botarkayan_title = "ตั้งไข่ล้มต้มไข่กิน";
} elseif ($botarkayan == 2) {
    $image_file = "../assets/img/literature/kapyani/botarkayan2.jpg";
    $botarkayan_title = "นี่ ของ ของ เธอ";
} elseif ($botarkayan == 3) {
    $image_file = "../assets/img/literature/kapyani/botarkayan3.jpg";
    $botarkayan_title = "ฝน ตก แดด ออก";
}
...
<div class="container py-5">
    <div class="row">
        <div class="col-md-9 order-md-4">
            ...
            <?php if (!empty($botarkayan)) : ?>
                <div class="d-flex flex-column text-left mb-3" style="margin-left: 30px;">

                    <div class="mb-5">
                        <img id="botarkayanImage" width="100%" height="auto" src="<?= $image_file ?>" alt="botarkayan Image" style="margin-top: 80px;">
                        <?php
                        $audio_file = '';
                        if ($botarkayan == 1) {
                            $audio_file = "../assets/audio/second3lines/botarkayan1.wav";
                        } elseif ($botarkayan == 2) {
                            $audio_file = "../assets/audio/second3lines/botarkayan2.wav";
                        } elseif ($botarkayan == 3) {
                            $audio_file = "../assets/audio/second3lines/botarkayan3.wav";
                        } 
                        ?>
        ...
        <div class="col-md-3 order-md-1">
            ...
            <h4 style="font-size: 36px; font-weight: bold;">บทอาขยาน</h4>

    </div>
            <br>
                <ul class="list-group">
                    <?php for ($i = 1; $i <= 3; $i++) : ?>
                        <li class="list-group-item <?php echo ($botarkayan == $i) ? 'active' : ''; ?>" style="background-color: <?php echo ($botarkayan == $i) ? '#A4DBD0' : '#f8f9fa'; ?>;">
                            <a href="?botarkayan=<?php echo $i; ?>" class="text-decoration-none">
                                <?php 
                                $botarkayan_text = '';
                                if ($i == 1) {
                                    $botarkayan_text = "๑. ตั้งไข่ล้มต้มไข่กิน";
                                } elseif ($i == 2) {
                                    $botarkayan_text = "๒. นี่ ของ ของ เธอ";
                                } elseif ($i == 3) {
