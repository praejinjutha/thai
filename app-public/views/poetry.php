...
<?php
$poetry = $_GET['poetry'] ?? ''; // ดึงค่าของพารามิเตอร์ poetry จาก URL
$poetry_title = '';
// กำหนดข้อความของแต่ละบทเรียน
if (empty($poetry) || $poetry == 1) {
  $poetry = 1;
  $image_file = "../assets/img/literature/pros/poetry1.jpg";
  $poetry_title = "ปีใหม่ไทย";
} elseif ($poetry == 2) {
    $image_file = "../assets/img/literature/pros/poetry2.jpg";
    $poetry_title = "ลากันไปโรงเรียน";
} elseif ($poetry == 3) {
    $image_file = "../assets/img/literature/pros/poetry3.jpg";
    $poetry_title = "ช้างพลาย";
}
...
<div class="container py-5">
    <div class="row">
        <div class="col-md-9 order-md-4">
            ...
            <?php if (!empty($poetry)) : ?>
                <div class="d-flex flex-column text-left mb-3" style="margin-left: 30px;">
                    ...
                    <div class="mb-5">
                        <img id="poetryImage" width="100%" height="auto" src="<?= $image_file ?>" alt="poetry Image" style="margin-top: 80px;">
                        <?php
                        $audio_file = '';
                        if ($poetry == 1) {
                            $audio_file = "../assets/audio/first2lines/poetry1.wav";
                        } elseif ($poetry == 2) {
                            $audio_file = "../assets/audio/first2lines/poetry2.wav";
                        } elseif ($poetry == 3) {
                            $audio_file = "../assets/audio/first2lines/poetry3.wav";
        ...
        <div class="col-md-3 order-md-1">
            ...
            <h4 style="font-size: 40px; font-weight: bold;">บทร้อยกรอง</h4>

    </div>
            <br>
                <ul class="list-group">
                    <?php for ($i = 1; $i <= 3; $i++) : ?>
                        <li class="list-group-item <?php echo ($poetry == $i) ? 'active' : ''; ?>" style="background-color: <?php echo ($poetry == $i) ? '#A4DBD0' : '#f8f9fa'; ?>;">
                            <a href="?poetry=<?php echo $i; ?>" class="text-decoration-none">
                                <?php 
                                $poetry_text = '';
                                if ($i == 1) {
                                    $poetry_text = "๑. ปีใหม่ไทย";
                                } elseif ($i == 2) {
                                    $poetry_text = "๒ .ลากันไปโรงเรียน";
                                } elseif ($i == 3) {
